...
#extract
path = "sonalshinde123/work-from-home-employee-burnout-dataset"
file_name = "work_from_home_burnout_dataset.csv"
...
# MAGIC %sql
# MAGIC select * from raw_kaggle_dataset where day_type = 'Weekday'

# COMMAND ----------

#transform
sql_statement = """ select * from raw_kaggle_dataset where day_type = 'Weekday' """

spark.sql(sql_statement).createOrReplaceTempView("df")

# COMMAND ----------

#load
load_to_delta_table("df", "piti_employee_burn_out")
